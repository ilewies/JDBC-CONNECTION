...
import com.lavesh.DBFactory.MysqlDBFactory;
...
public class MysqlDB {
	...
	public static void getMysqlDB() {
		...
		ResultSet rs = null;
	try {
		MysqlDBFactory.loadMysqlDBDriver();
		con = MysqlDBFactory.getMysqlDBConnection();
		st = MysqlDBFactory.getOracleDBStatement();
